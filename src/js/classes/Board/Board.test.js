...
describe("Given the randomize method of the Board class", () => {
  describe("When it is used to create a random board set", () => {
    ...
    test("Then the number of columns of the first row of the board should be equal to 60", () => {
      const expectedNumberOfColumns = 60;
    ...
    test("Then the number of columns of the last row of the board should be equal to 60", () => {
      const expectedNumberOfColumns = 60;
